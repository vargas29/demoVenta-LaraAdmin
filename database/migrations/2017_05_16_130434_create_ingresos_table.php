...
class CreateIngresosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Ingresos", 'ingresos', 'codigo', 'fa-xing', [
            ["codigo", "Codigo", "Integer", true, "", 0, 11, false],
            ["id_proveedor", "Proveedor", "Dropdown", false, "", 0, 0, false, "@proveedors"],
            ["fecha", "Fech", "Datetime", false, "", 0, 0, true],
        ]);
